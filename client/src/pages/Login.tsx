    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-sm p-8 rounded-2xl border border-border bg-card shadow-lg flex flex-col items-center gap-6">
        ...
        <Button
          ...
          disabled={loading}
          className="w-full flex items-center gap-3 bg-white text-gray-800 border border-gray-300 hover:bg-gray-50 shadow-sm"
          variant="outline"
        >
